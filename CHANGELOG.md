...
- **K12-F**: `orq pausar` e `orq retomar` gravam `PAUSA`/`RETOMADA por=terminal` na
...
- **K12-J**: apuração de razões em segundo plano por repo, com cache, timeout de 10 s e
  recuo de 1, 2, 5 e 10 min; o `/api/estado` não espera um repo lento.
